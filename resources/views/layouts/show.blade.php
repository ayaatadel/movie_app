...
@section('content')
    <div class="movie-info border-b border-gray-800">
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row p-2">
            <img src="{{ 'https://image.tmdb.org/t/p/w500/' . $movie['poster_path'] }}" alt="poster" class="md:w-96 w-64">
            <div class="md:ml-24 show-color p-6">
                ...
                <div class="flex  flex-wrap items-center show-color mt-2">
                    ...
                    <span
                        class="text-color ml-1">{{ \Carbon\Carbon::parse($movie['release_date'])->format('M d,Y') }}</span>
            ...
            <div x-data="{ isOpen: false }"> {{-- /////// --}}
                @if (count($movie['videos']['results']) > 0)
                    <div class="mt-12">
                        <button @click="isOpen = true" {{-- href="https://www.youtube.com/watch?v={{ $movie['videos']['results'][0]['key'] }}" --}}
                ...
                @if ($loop->index < 5)
                    <div class="mt-8">
                        ...
                        <div class="mt-2 text-color text-sm">
                            <a href="#" class="text-lg mt-2 show-color">{{ $cast['name'] }} </a>
                            <div class="flex items-center text-gray-400 mt-2">

                                <span class="text-color ml-1 "> {{ $cast['character'] }}</span>
