<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="nav-color">
        <div class="container" style="width:85%; margin:auto;">
            <div class="dev-style">
                <ul class="flex  px-4 py-6 items-center">
                    {{-- Logo --}}
                    <li class="ml-6 w-20">
                    ...
                    <li class="ml-6">
                        <a href="#" class="text-color ml-12">Movies</a>
                    </li>
                    <li class="ml-6">
                ...
                <div class="flex items-center">
                    <div class="relative ">
                        ...
                        <div class="absolute top-0">
                            <svg class="fill-current text-gray-500 ml-1 mr-2" fill="#000000"
                                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30" width="25px" height="30px">
                                <path
