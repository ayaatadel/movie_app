...
@section('content')
        ...
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            ...
            <div class="md:ml-24 show-color p-6">
                ...
                <div class="flex  flex-wrap items-center show-color mt-2">
                    <svg class="fill-current text-gray-400 hover:text-white w-4" style="color: bisque"viewBox="0 0 448 512">
                        <path
                    ...
                    <span class="text-color ml-2 "> {{ $actor['birthday'] }} ({{ $actor['age'] }} years old ) in
                    ...
                    @foreach ($knownForMovies as $movie)
                        <div class="mt-4">
                            <a href="{{ $movie['linkToPage'] }}">
                                ...
                                <img src="{{ $movie['poster_path'] }}" alt="poster" alt="poster"
    ...
    {{-- <            end        > --}}
    <div class="credits border-b border-gray-800 text-color">
        <div class="container mx-auto px-4 py-16">
            <h2 class="text-4xl font-semibold  text-color">Credits</h2>
            <ul class="list-desc leading-loose pl-5 mt-8">
