...
@section('content')
        ...
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row p-2">
            ...
            <div class="md:ml-24 show-color p-6">
                ...
                <div class="flex  flex-wrap items-center show-color mt-2">
                    ...
                    <span class="text-color ml-1 "> {{ $tvShow['vote_average'] }}</span>
                    <span class="text-color ml-1">|</span>
                    <span class="text-color ml-1">{{ $tvShow['first_air_date'] }}</span>
                    ...
                    <div class="flex mt-4 text-color">
                        ...
                        @foreach ($tvShow['created_by'] as $crew)
                            <div class="mr-8">
                                ...
                                <div class="text-sm text-gray-400">Creator
                ...
                @foreach ($tvShow['cast'] as $cast)
                    <div class="mt-8">
                        ...
                        <div class="mt-2 text-color text-sm">
                            <a href="{{ route('actors.show', $cast['id']) }}"
                                class="text-lg mt-2 show-color">{{ $cast['name'] }} </a>
    ...
    <div class="tv-image  x-data="{ isOpen: false, image: '' }">
        <div class="container mx-auto px-4 py-16">
